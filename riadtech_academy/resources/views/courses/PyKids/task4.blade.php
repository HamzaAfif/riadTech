...
<head>
    ...
    <title>Task 4: Choose a Path - Python for Kids</title>
...
<body class="bg-blue-50 font-sans antialiased">
    ...
    <main class="container mx-auto px-4 py-8">
        <h2 class="text-3xl font-bold text-blue-800 mb-6">Task 4: Choose a Path</h2>
        <p class="text-gray-600 mb-4">Pick a path for Pippin! Type <code>path = "right"</code>. Cheat code: <code>pass pass</code>.</p>
        <div class="bg-white p-4 rounded-lg shadow-md">
            <label class="block text-sm font-medium text-gray-700 mb-2">Type your code:</label>
            <textarea class="code-input border rounded p-2" data-answer='path = "right"'></textarea>
        ...
        <div class="mt-6 flex justify-between">
            <a href="task3.html" class="bg-gray-300 text-gray-700 py-2 px-4 rounded hover:bg-gray-400">Previous</a>
