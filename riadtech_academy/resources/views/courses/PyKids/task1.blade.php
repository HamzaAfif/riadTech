...
<head>
    ...
    <title>Task 1: Say Hi! - Python for Kids</title>
...
<body class="bg-blue-50 font-sans antialiased">
    ...
    <main class="container mx-auto px-4 py-8">
        <h2 class="text-3xl font-bold text-blue-800 mb-6">Task 1: Say Hi!</h2>
        <p class="text-gray-600 mb-4">Pippin the Python says hi! Type <code>print("Hi!")</code> to reply. Cheat code: <code>pass pass</code>.</p>
        <div class="bg-white p-4 rounded-lg shadow-md">
            <label class="block text-sm font-medium text-gray-700 mb-2">Type your code:</label>
            <textarea class="code-input border rounded p-2" data-answer='print("Hi!")'></textarea>
        ...
        <div class="mt-6 flex justify-between">
            <a href="index.html" class="bg-gray-300 text-gray-700 py-2 px-4 rounded hover:bg-gray-400">Previous</a>
